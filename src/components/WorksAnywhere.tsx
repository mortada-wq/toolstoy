export function WorksAnywhere() {
  ...
  return (
    <section className="px-4 md:px-6 py-16 bg-white">
      <p className="text-toolstoy-muted text-xs font-normal tracking-[0.1em] uppercase text-center">
        Works on any platform
      </p>
      <div className="mt-4 flex flex-wrap justify-center items-center gap-x-7 md:gap-x-12">
        {platforms.map((platform, i) => (
          <span key={platform} className="text-toolstoy-muted font-normal text-[15px]">
            {platform}
